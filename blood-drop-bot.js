...
function eightBall(arguments, receivedMessage) {
    ...
    if (arguments == 0) {
        ...
        var eightBallResponse = eightBallArray[Math.floor(Math.random()*eightBallArray.length)];
        receivedMessage.channel.send(`You asked: ${receivedMessage.content.slice(6)} \n Magic 8Ball says: ${eightBallResponse}`);
    }
 }
